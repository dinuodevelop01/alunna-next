...
import { makeStyles, Theme, Grid, Container, Box, Button } from '@material-ui/core';
          ...
          <Grid container spacing={4}>
            ...
            <Grid item md={4} sm={4} xs={12}>
              ...
              <div style={{ marginTop: '20px' }}>
                ...
                /> */}
                {courses.map(course => (
                  <div style={{ cursor: 'pointer' }} onClick={() => history.push('/notFound')}>
                    <TextFooterNormal
                      styleCustom={'5px'}
                      text={course.name}
                    />
            ...
            <Grid item md={2} sm={4} xs={12}>
              ...
              <Box marginTop={3}>
                ...
                <div style={{ cursor: 'pointer' }} onClick={() => history.push('/howWork')}>
                  <TextFooterNormal styleCustom={'5px'} text={'How it works'} />
                </div>
                <div style={{ cursor: 'pointer' }} onClick={() => history.push('/contact')}>
